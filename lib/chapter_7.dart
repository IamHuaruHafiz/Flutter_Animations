...
class AnimationsChapterSeven extends StatelessWidget {
  const AnimationsChapterSeven({super.key});
...
class _MyDrawerState extends State<MyDrawer> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final maxDrag = screenWidth * 0.80;
        ...
        builder: (context, child) {
          return Stack(
            children: [
              ...
              Transform(
                //the setEntry gives the animation a perspective view
                transform: Matrix4.identity()
                  ..setEntry(3, 2, 0.001)
                  ..translate(
